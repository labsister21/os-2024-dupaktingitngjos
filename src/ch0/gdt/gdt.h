 ...
 * @param non_system   1-bit contain S -- descriptor type (0 = system, 1 = code or data)
 * @param privilege    2-bit contain DPL -- descriptor privilege level
 * @param valid_bit    1-bit contain P -- segment present
 * @param segment_high 4-bit higher-bit segment limit
 * @param avl          1-bit contain AVL -- available for use by system software
 * @param long_mode    1-bit contain L -- 64-bit code segment (IA-32e mode only)
 * @param opr_32_bit   1-bit contain D/B -- default operation size (0 = 16-bit segment, 1 = 32-bit segment)
 * @param granularity  1-bit contain G -- granularity
