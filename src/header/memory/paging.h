 ...
 * @param read_write        Indicates whether the page is read-only or read-write
 * @param user_supervisor   Indicates whether the page is accessible in user mode or supervisor mode
 * @param write_through     Indicates whether write-through caching is enabled for the page
...
struct PageDirectoryEntry {
    ...
    uint16_t reserved_1     : 4; // Reserved bits (4-bit)
