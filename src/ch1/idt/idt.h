...
struct IDTGate {
    ...
    // Next 16-bit
    uint8_t _reserved : 5;              // Reserved
    uint8_t _r_bit_1 : 3;               // From bit-5 to bit-7
    uint8_t _r_bit_2 : 3;               // From bit-8 to bit-10
    uint8_t gate_32 : 1;                // D
    uint8_t _r_bit_3 : 1;               // bit-12
    uint8_t DPL : 2;                    // DPL
    uint8_t valid_bit : 1;              // Present
...
// ...
struct IDT {
    // List of IDTGate with max capacity of 256
